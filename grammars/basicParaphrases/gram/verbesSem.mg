...
class n0Vn1[E,X,Y,T1,T2,P]{
 		binaryRel[]*=[index=E,arg1=X,arg2=Y,theta1=T1,theta2=T2,rel=P] ;
...
class n0Vn1an2[E,X,Y,Z,T1,T2,T3,P]{
		ternaryRel[]*=[index=E,arg1=X,arg2=Y,arg3=Z,theta1=T1,theta2=T2,theta3=T3,rel=P] ;
		{n0Vn1[E,X,Y,T1,T2,P];
 		Iobject[]*=[iobjectI=Z]}
}
