...
macros, trees and nodes.  

\paragraph{Macros} consist of (1) a family name and (optionally) 
a macro name, (2) a list of parameters (3) ``initial''
...
<macro>   := <famid> "(" <param>* ")" <initaux> <tree> 
<famid>   := <name>
           | <name> ":" <name>
